...
const services: Service[] = [
  {
    ...
    heroImage: pic("indian-living.jpg", "Elegant Indian home living room interior"),
    gallery: [pic("indian-living-2.jpg", "Warm Indian living room"), pic("indian-living-3.jpg", "Spacious Indian living space"), img("17", "Minimal living room"), img("11", "Open-plan living space")],
  ...
  },
  {
    ...
    heroImage: img("10", "Custom wooden wardrobe panelling"),
    published: true,
  },
  {
  ...
  },
  {
    ...
    heroImage: img("23", "Living room with detailed ceiling and lighting"),
    featured: true,
    published: true,
  },
  {
  ...
  },
  {
    ...
    heroImage: pic("kitchen-open.jpg", "Bright open modular kitchen with island and dining"),
    gallery: [
      pic("kitchen-grey.jpg", "Modern grey modular kitchen"),
      pic("kitchen-violet.jpg", "Glossy modular kitchen with island"),
      pic("kitchen-green.jpg", "Contemporary modular kitchen finish"),
      pic("kitchen-dine.jpg", "Modular kitchen with dining area"),
      pic("quartz-kitchen.jpg", "Kitchen with quartz countertop and chimney"),
      pic("kitchen-chimney.jpg", "Modular kitchen island with built-in chimney"),
    ],
    featured: true,
    published: true,
  },
  {
    ...
    heroImage: pic("bathroom-tiles.jpg", "Modern bathroom with tiled shower and stone vanity"),
    featured: true,
    published: true,
  },
  {
  ...
  },
  {
    ...
    heroImage: pic("indian-bedroom.jpg", "Cosy Indian bedroom interior"),
    gallery: [pic("indian-bedroom-2.jpg", "Warm Indian bedroom design"), pic("indian-bedroom-3.jpg", "Modern Indian bedroom"), pic("bedroom.jpg", "Contemporary bedroom"), pic("bedroom-2.jpg", "Bedroom styling")],
    featured: true,
    published: true,
  },
  {
  ...
  },
  {
    ...
    heroImage: img("31", "Living room entertainment unit wall"),
    featured: true,
    published: true,
  },
  {
  ...
  },
  {
    ...
    heroImage: pic("temple-1.jpg", "Custom wooden temple / pooja unit with jaali doors"),
    gallery: [
      pic("temple-2.jpg", "Backlit wooden pooja unit"),
      pic("temple-3.jpg", "Carved mandir with mandala backdrop"),
      pic("temple-4.jpg", "Wooden temple unit with lattice work"),
      pic("temple-5.jpg", "Compact home temple unit"),
      pic("temple-6.jpg", "Marble and wood pooja unit"),
    ],
    featured: true,
    published: true,
  },
...
const projects: Project[] = [
  {
    ...
    cover: pic("indian-living.jpg", "Contemporary Indian apartment living room"),
    gallery: [pic("indian-living-2.jpg", "Living room overview"), pic("indian-living-3.jpg", "Open living space"), img("17", "Living detail"), img("11", "Open living space")],
    featured: true,
    published: true,
  },
  {
    ...
    cover: pic("kitchen-grey.jpg", "Modern grey modular kitchen makeover"),
    gallery: [
      pic("kitchen-open.jpg", "Bright open modular kitchen"),
      pic("kitchen-violet.jpg", "Glossy modular kitchen with island"),
      pic("kitchen-green.jpg", "Contemporary modular kitchen"),
      pic("kitchen-dine.jpg", "Modular kitchen with dining area"),
    ],
    featured: true,
    published: true,
  },
  {
    ...
    cover: pic("indian-bedroom.jpg", "Serene Indian master bedroom"),
    gallery: [pic("indian-bedroom-2.jpg", "Cosy bedroom design"), pic("indian-bedroom-3.jpg", "Warm bedroom"), pic("bedroom.jpg", "Bedroom detail"), pic("bedroom-3.jpg", "Bedroom styling")],
    featured: true,
    published: true,
  },
  {
